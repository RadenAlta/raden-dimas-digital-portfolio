...
Halaman `gallery.html` berisi hero, breadcrumb, pengantar, filter, result count, grid, empty state, dialog lightbox, CTA, dan footer. Empat gambar credential lokal yang lolos pemeriksaan digunakan; kategori Projects dan Learning Activities sengaja kosong.
